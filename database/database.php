...
$products = [
    new ProductAnimal('Collare', '8,99', 'https://www.delashop.it/wp-content/uploads/2021/05/XSblu-picc.jpg', 'dog',),
...
$products[4]->setWeight('1200', 'g');
$products[3]->setWeight('900', 'g');
